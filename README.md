# Counter-Strike 2 ESP Loader (Undetectable)
...
- 💯 Undetectable - Injection is hidden from the game.
- 🧬 Self-Healing - No need to rebuild after game update.
- 🚀 Performant - 0 frame cost, no FPS drop while playing.
